 ...
 * 
 * Once powering on the board, you will see in a couple of minutes a web page
 * with links to turn on or off the builtin led.
 * 
 * Check the url first in the serial monitor, before disconnecting the board from the sketch flasher/installer.
 * 
